...
protected:
    ...
    void wrtVariableJ4Amplitude(Eigen::MatrixXd& partialDerivatives);
    void wrtVariableJ4Period(Eigen::MatrixXd& partialDerivatives);
    void wrtVariableJ4Phase(Eigen::MatrixXd& partialDerivatives);
